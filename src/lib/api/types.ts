...
export interface paths {
    ...
    "/api/v1/gmail/watch/labels": {
         ...
         * @description Set which Gmail labels to monitor. Provide createLabelName to create a new label, or labelIds to use existing labels.
         */
        post: {
            parameters: {
                query?: never;
    ...
    "/api/v1/gmail/filters/senders": {
        ...
        /**
         * Set sender filter
         * @description Create a Gmail filter that auto-applies the monitor label to emails from the given sender addresses.
         */
        post: {
            parameters: {
                query?: never;
        ...
        get: {
            parameters: {
                query?: {
                    startDate?: string;
                    endDate?: string;
                    /** @description IANA timezone identifier (e.g., "Asia/Kathmandu"). Overrides user default timezone for date filter conversion. */
                    timezone?: string;
                };
                header?: never;
                path?: never;
    ...
    "/api/v1/insights/latest": {
        ...
        /**
         * Get latest insights
         * @description Fetch the most recent financial insights for the authenticated user. Supports pagination via limit and offset.
         */
        get: {
            parameters: {
                query?: {
    ...
    "/api/v1/insights/generate": {
         ...
         * @description Manually generate AI-powered financial advice based on transactions in the given period. Uses Gemini 2.5 Flash. Saves the result to the database.
         */
        post: {
            parameters: {
                query?: {
                    /** @description Start of period (ISO datetime). Defaults to start of current month in user timezone. */
                    startDate?: string;
                    /** @description End of period (ISO datetime). Defaults to end of current month in user timezone. */
                    endDate?: string;
                    /** @description IANA timezone (e.g., Asia/Kathmandu). Overrides user default for period calculation. */
                    timezone?: string;
                };
                header?: never;
                path?: never;
